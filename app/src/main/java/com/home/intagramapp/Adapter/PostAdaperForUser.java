...
public class PostAdaperForUser extends RecyclerView.Adapter<PostAdaperForUser.ViewHolder> {

        public Context mContext;
        public List<Post> mPost;
        private FirebaseUser firebaseUser;

    public PostAdaperForUser(Context mContext, List<Post> mPost) {
        ...
        @NonNull
        @Override
        public PostAdaperForUser.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {

            View view = LayoutInflater.from(mContext).inflate(R.layout.post_item,viewGroup,false);

            return new PostAdaperForUser.ViewHolder(view);
        }

        @Override
        public void onBindViewHolder(@NonNull final PostAdaperForUser.ViewHolder viewHolder, int i) {
        ...
        private  void  publisherinfo(final ImageView image_profile, final TextView username , final TextView publisher , String userid ){
            ...
            DatabaseReference reference = FirebaseDatabase.getInstance().getReference("TypeOrg").child(userid);
