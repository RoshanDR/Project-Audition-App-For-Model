...
public class Admin_ProfileUActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin__profile_u);
        progressBar=findViewById(R.id.progress);
        button=findViewById(R.id.fragment3btn);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Admin_ProfileUActivity.this, ImageActivityForUser.class));
            }
        });
       ...
       /* recyclerView = view.findViewById(R.id.recycler_user);
        ...
        myFotosAdapter  = new ImageAdapterForUesr(getContext(), postList);
      ...
      /*  edit_profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(btn.equals("Edit Profile")){
                    startActivity(new Intent(Admin_ProfileUActivity.this, EditProfileUser.class));
        ...
        options.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Admin_ProfileUActivity.this, OptionsActivity.class);
...
*/
        followers.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Admin_ProfileUActivity.this, FollowersActivity.class);
    ...
    private  void  userInfo(){
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference("TypeUsers").child(profileid);
